...
Character.create(name: "Bobo", health: 100, sprite_img: "../mod3FInalProject/backend/assets/images/sheet_hero_walk.gif")
...
Monster.create(name: "Monster 1", level_id: Level.all.first.id, health: 50, sprite_img: "../mod3FInalProject/backend/assets/images/wizard_idle.gif", attack_img: "../assets/images/wizard_attack.png", death_img: "../assets/images/explosion-4.png")
...
Item.create(name: "Candy", ability: "Sugar Rush! You rotted your teeth from too much candy! Lose Health", level_id: Level.all.first.id, sprite_img: "../mod3FInalProject/backend/assets/images/candy.png")
Item.create(name: "Candy", ability: "Sugar Rush! You rotted your teeth from too much candy! Lose Health", level_id: Level.all[1].id, sprite_img: "../mod3FInalProject/backend/assets/images/candy.png")
Item.create(name: "Candy", ability: "Sugar Rush! You rotted your teeth from too much candy! Lose Health", level_id: Level.all[2].id, sprite_img: "../mod3FInalProject/backend/assets/images/candy.png")
